...
void Date:: add_day(int n) {
    while(n--)//when n>0 continously day+1, so this equals to day+n
    {  
            if(leapyear(y))//the days in February is different in leap year and not a leap year
            {
            switch(m){//using a switch to treat different days in different month
